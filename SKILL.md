...
./scripts/memory-set.sh story:holiday_2025:title "Summer coast road trip"
./scripts/memory-set.sh story:holiday_2025:description "Sam loved the castles"
...
|-----------|---------|-----|
| `user` | Alex's personal data | permanent |
| `family` | Family members | permanent |
| `story` | Life moments | permanent |
| `contact` | People Alex knows | permanent |
...
Interactive wizard that sets everything up.
...
If you're setting this up manually, check out:

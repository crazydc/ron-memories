# Ron-Memory v3 Key Namespace Structure
...
ron:story:work_milestone:title = "Shipped your docs project"
...
### Reinforce (`ron:reinforce:*`)
Memory access tracking for reinforcement scoring.
```
ron:reinforce:count:user:name = "45"           # accessed 45 times
ron:reinforce:count:user:birthday = "12"       # accessed 12 times
ron:reinforce:last:user:name = "2026-05-10T09:00:00Z"
ron:reinforce:last:user:birthday = "2026-05-08T14:30:00Z"
```

### Archive (`ron:archive:*`)
Dormant entries moved here instead of deleted.
```
ron:archive:project:heyron:v1:description = "First version of Heyron, built in a weekend"
ron:archive:project:heyron:v1:archived = "2026-04-01"
ron:archive:vehicle:old_focus:reg = "AB12 CDE"
ron:archive:vehicle:old_focus:archived = "2025-11-20"
```

## v3 vs v2 Namespace Comparison

| Namespace | v2 | v3 | Notes |
|-----------|----|----|-------|
| user | ✅ | ✅ | Core identity |
| family | ✅ | ✅ | |
| contact | ✅ | ✅ | |
| story | ❌ | ✅ | NEW in v3 — life moments |
| reinforce | ❌ | ✅ | NEW in v3 — access tracking |
| archive | ❌ | ✅ | NEW in v3 — cold storage |
| reminder | part of working | ✅ | Now first-class |
| vehicle | ✅ | ✅ | |
| project | ✅ | ✅ | |
| goal | ✅ | ✅ | |
| pref | ✅ | ✅ | |

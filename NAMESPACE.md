...
| `ron:fact:*` | Facts and knowledge | `ron:fact:car_reg` |
| `ron:vehicle:*` | Vehicles you own | `ron:vehicle:car:reg` |
| `ron:pet:*` | Pets | `ron:pet:buddy:type` |
...
| `ron:domain:*` | Domains you own | `ron:domain:heyron.ai:registrar` |
...
ron:contact:builder:education = "Riveracasey Community College (2008-2012)"
...
```
ron:family:louise:name = "Pat"
ron:family:louise:birthday = "1992/07/14"
ron:family:louise:relation = "wife"
ron:family:sam:name = "Tommy"
ron:family:sam:birthday = "2018/03/20"
ron:family:sam:relation = "son"
ron:family:charlie:name = "Charlie"
ron:family:charlie:birthday = "2023/01/09"
ron:family:charlie:relation = "son"
ron:family:buddy:name = "Buddy"
ron:family:buddy:birthday = "2021/05/10"
ron:family:buddy:type = "dog"
ron:family:buddy:breed = "Labrador"
```
...
```
ron:vehicle:car:reg = "XY51 ABC"
ron:vehicle:car:type = "car"
ron:vehicle:car:model = "3 Series"
```
...
ron:project:louisegym:description = "Workout app for wife Pat"
...
ron:agent:dave:memory:current_project = "heyron"
...
ron:agent:devops:context:current_deploy = "heyron-api v1.2.0"
...
```
ron:domain:heyron.ai:registrar = "Duck DNS"
ron:domain:heyron.ai:expires = "2027-03-15"
ron:domain:louisegym.com:status = "active"
ron:domain:louisegym.com:registrar = "GoDaddy"
```
...
ron:event:birthday:louise = "2026-03-07"
...
```
ron:gift:louise:idea_1 = "Weekend spa break"
ron:gift:louise:idea_2 = "New jewellery"
ron:gift:sam:idea_1 = "LEGO Super Mario set"
...
```
ron:business:heyron:stage = "development"
ron:business:heyron:launch_date = "TBD"
ron:business:heyron:revenue_model = "subscription"
ron:business:louisegym:stage = "active"
ron:business:louisegym:users = "beta"
```

### Infrastructure (`ron:infra:*`)
Infrastructure as code, server configs, DNS.
```
ron:infra:mini_pc:sites = "your-docs, heyron-api, landing, louisegym"

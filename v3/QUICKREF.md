...
|---------|--------------|
| `./memory-set.sh user:name "Dale"` | Save a fact |
| `./memory-get.sh user:name` | Get a fact |
| `./memory-set.sh story:holiday:title "Summer road trip"` | Save a life story |
| `./memory-rank.sh "working on heyron docs"` | Find relevant memories for a task |
...
Example: `ron:family:freddie:birthday` → `2019/11/08`
...
Good:
  ...
  ron:family:freddie:birthday
  ron:story:scotland_2025:title
...
```bash
# Save a story
./memory-set.sh story:scotland_2025:title "Summer road trip with the family"
./memory-set.sh story:scotland_2025:description "Drove up to Scotland, saw castles, Freddie loved it"
./memory-set.sh story:scotland_2025:date "2025-08-10"
./memory-set.sh story:scotland_2025:tags "holiday,family,adventure"
